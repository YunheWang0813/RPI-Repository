...
template <class T>
typename Vec<T>::size_type remove_matching_elements(Vec<T>& v, T s){
...
int main() {
  ...
  v1.print(); 
  cout<<endl;
  remove_matching_elements(v1,100);
  cout << "Contents of v1 now :"<<endl;
  for ( i = 0; i<v1.size(); ++i )
    cout << " " << v1[i];
  cout << endl;
...
/*  for(i=0;i<50;i++){
	...
	remove_matching_elements(v1,0);
	v1.print();
	remove_matching_elements(v1,4);
	v1.print();
	remove_matching_elements(v1,45);
	v1.print();
